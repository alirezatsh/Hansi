...
running command...
$ hansi (--version)
hansi/0.0.8 linux-x64 node-v24.4.0
$ hansi --help [COMMAND]
USAGE
  $ hansi COMMAND
...
...
_See code: [src/commands/local/django/init.ts](https://github.com/alirezatsh/Hansi/blob/v0.0.8/src/commands/local/django/init.ts)_
